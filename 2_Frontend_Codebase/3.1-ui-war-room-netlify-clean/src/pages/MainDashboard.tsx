...
export default function MainDashboard() {
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      ...
      console.log('MainDashboard: Found blob containers:', blobContainers.length);
      console.log('MainDashboard: Found feedWrapper:', !!feedWrapper);
                ...
                <div className="card swot-intelligence">
                  <div className="swot-radar">
                    <div className="radar-container">
                      ...
                      {/* Quadrant Labels */}
                      <div className="radar-quadrant" style={{ top: '15px', right: '15px' }}>
                        STRENGTHS
                      </div>
                      <div className="radar-quadrant" style={{ top: '15px', left: '15px' }}>
                        WEAKNESSES
                      </div>
                      <div className="radar-quadrant" style={{ bottom: '15px', right: '15px' }}>
                        OPPORTUNITIES
                      </div>
                      <div className="radar-quadrant" style={{ bottom: '15px', left: '15px' }}>
                        THREATS
                      </div>
                    ...
                    <div className="feed-container" id="feedContainer">
                      <div className="feed-items-wrapper" id="feedWrapper">
                        <div className="feed-item info" data-id="wisconsin-opens">
                          <span>
                            <strong>UPDATE:</strong> Wisconsin voter registration up 34%.
                          </span>
                        </div>
                        <div className="feed-item warning">
                          <span>
                            <strong>WARNING:</strong> Major news outlet published critical article.
                          </span>
                        </div>
                        <div className="feed-item info" data-id="fl-suburbs">
                          <span>
                            <strong>INFO:</strong> Positive sentiment in Florida suburbs +12%.
                          </span>
                        </div>
                        <div className="feed-item critical" data-id="viral-negative">
                          <span>
                            <strong>CRITICAL:</strong> Viral negative mention detected. 12K retweets
                            in PA.
                          </span>
                        </div>
                        <div className="feed-item warning" data-id="competitor-launch">
                          <span>
                            <strong>WARNING:</strong> Competitor launched $250K ad campaign.
                          </span>
                        </div>
                        <div className="feed-item info" data-id="youth-engagement">
                          <span>
                            <strong>INFO:</strong> Youth voter engagement up 23% in Michigan.
                          </span>
                        </div>
                        <div className="feed-item info">
                          <span>
                            <strong>UPDATE:</strong> Meta ads performing 52% above benchmark.
                          </span>
                        </div>
                        <div className="feed-item warning" data-id="ad-fatigue">
                          <span>
                            <strong>ALERT:</strong> Ad fatigue detected in target demographics.
                          </span>
                        </div>
                        <div className="feed-item info" data-id="brand-recognition">
                          <span>
                            <strong>INFO:</strong> Brand recognition increased 18% this week.
                          </span>
                        </div>
                        <div className="feed-item critical">
                          <span>
                            <strong>CRITICAL:</strong> Opposition video trending #1 on Twitter.
                          </span>
                        </div>
