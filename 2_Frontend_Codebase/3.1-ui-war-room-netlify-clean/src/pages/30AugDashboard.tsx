...
export default function ThirtyAugDashboard() {
  ...
  return (
    ...
    >
      ...
      <div className="30-aug-dashboard" style={{ paddingTop: '80px' }}>
        <div
          style={{
        ...
        {/* Keywords Bottom Display - Shows on tablets/mobile */}
        <div className="keywords-bottom">
          <span className="keyword-item">ECONOMY</span>
          <span className="keyword-dot"></span>
          <span className="keyword-item">HEALTHCARE</span>
          <span className="keyword-dot"></span>
          <span className="keyword-item">DONALD TRUMP</span>
        </div>
      </div>
    </PageLayout>
  );
